          ...
          <div class=\"col-lg-101\">
            <div class=\"p-5\">
              <div class=\"text-center\">
                <h1 class=\"h4 text-gray-900 mb-4\" style=\"font-size: 2.1rem;line-height: 0.8;font-weight: 900;letter-spacing: 0.118em;font-style: normal;\">Cadastro de Médicos</h1>
              </div>
              <form class=\"user\" method=\"POST\" action=\"cadastrando_medico.php\">
                ...
                <div class=\"form-group row\">
                  ...
                  <div class=\"col-sm-6\">
                    <input type=\"text\" class=\"form-control form-control-user\" id=\"crm\" name=\"crm\" placeholder=\"CRM\" required>
                  </div>
                </div>
                <div class=\"form-group row\">
                  <div class=\"col-sm-6 mb-3 mb-sm-0\">
                ...
                <div class=\"form-group row\">
                  <div class=\"col-sm-6\">
                    <input type=\"date\" class=\"form-control form-control-user\" id=\"data\" name=\"data\" placeholder=\"Idade\" required>
                  </div>
                ...
                <input type=\"submit\" class=\"btn btn-primary btn-user btn-block\" value=\"Cadastrar\" id=\"cadastrard\" name=\"cadastrard\">
