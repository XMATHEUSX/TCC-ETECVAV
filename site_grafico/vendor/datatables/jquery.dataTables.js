...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( lang ) {
			...
			if ( ! lang.sEmptyTable && zeroRecords &&
				defaults.sEmptyTable === "Sem dados disponíves " )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Sem dados disponíves "
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Sem dados disponíves ",
			 ...
			 *  @type string
			 *  @default (filtrado de _MAX_ entradas totais)
			 *
			 *  @dtopt Language
